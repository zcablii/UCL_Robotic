...
class AOCTILEPlanner(CellBasedForwardSearch):
    ...
    def pushCellOntoQueue(self, cell):
        ...
        if(cell.parent):
            cell.pathCost = cell.parent.pathCost + self.computeLStageAdditiveCost(cell.parent, cell) + self.octileCost(self.goal, cell)
        cost = cell.pathCost
    ...
    def resolveDuplicate(self, cell, parentCell):
        predicted_cost = parentCell.pathCost + self.computeLStageAdditiveCost(parentCell, cell) + self.octileCost(self.goal, cell)
