...
from comp0037_planner_controller.ADiagonal_planner import ADIAGONALPlanner
import map_getter
import rospy

# Initialise node
rospy.init_node('AEuclidean_standalone', anonymous=True)
...
planner = ADIAGONALPlanner('A* search', occupancyGrid)
